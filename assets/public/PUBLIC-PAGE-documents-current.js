...
(function () {
  ...
  function signedPdfPreviewUrl(url) {
    ...
    if (!clean) return "";
    return clean.includes("#") ? clean : `${clean}#toolbar=0&navpanes=0&pagemode=none&view=FitH&zoom=page-fit&page=1`;
  }
