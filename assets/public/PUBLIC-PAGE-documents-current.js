...
(function () {
  ...
  function buildCss(config) {
    return `
      ...
      .syncetc-doc-card{display:grid;gap:16px;align-content:space-between;min-height:190px;padding:18px;border:1px solid ${config.border};border-radius:${config.radius};background:#fff;box-shadow:0 8px 20px rgba(12,38,64,.08)}.syncetc-doc-card h3{margin:0 0 8px;color:${config.text};font-size:19px;line-height:1.15}.syncetc-doc-card p{margin:0;color:${config.muted};font-size:14px;line-height:1.55}.syncetc-doc-meta{margin-top:10px;color:${config.muted};font-size:12px;line-height:1.4}.syncetc-doc-actions{display:flex;gap:8px;flex-wrap:wrap}.syncetc-doc-button{display:inline-flex;align-items:center;justify-content:center;min-height:38px;padding:8px 14px;border-radius:999px;background:${config.primary};color:#fff!important;text-decoration:none;font-weight:900;font-size:13px;white-space:nowrap;border:1px solid ${config.primary};cursor:pointer}.syncetc-doc-button.secondary{background:#fff;color:${config.primary}!important;border-color:${config.border}}
      .syncetc-docs-note{margin-top:20px;padding:16px 18px;border-radius:${config.radius};border:1px solid ${config.border};background:${rgba(config.primary,.06)};color:${config.muted};font-size:13px;line-height:1.55}.syncetc-docs-empty{padding:22px;border:1px dashed ${config.border};border-radius:${config.radius};background:#fff;color:${config.muted};text-align:center;font-weight:800}.syncetc-doc-modal-backdrop{position:fixed;inset:0;display:none;align-items:center;justify-content:center;background:rgba(7,24,42,.72);z-index:2147483000;padding:24px}.syncetc-doc-modal-backdrop.is-open{display:flex}.syncetc-doc-modal{width:min(1100px,96vw);height:min(820px,92vh);background:#fff;border-radius:18px;box-shadow:0 24px 80px rgba(0,0,0,.38);display:grid;grid-template-rows:auto minmax(0,1fr);overflow:hidden}.syncetc-doc-modal-head{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:12px 14px;border-bottom:1px solid ${config.border};background:${rgba(config.primary,.06)}}.syncetc-doc-modal-frame{width:100%;height:100%;border:0;background:#fff}@media(max-width:720px){.syncetc-docs-main,.syncetc-docs-hero{padding:20px}.syncetc-doc-actions{display:grid}.syncetc-doc-button{width:100%}.syncetc-docs-list{grid-template-columns:1fr}}
    `;
  }
