...
// Purpose: Shared shell for signed-in user and organization-admin pages. Uses one Supabase Auth login; roles decide access.
...
(function () {
  ...
  let state = { authenticated: false, email: "", mode: "user" };
