...
(function () {
  ...
  function render() {
    ...
    if (token && (access.length || selectedOrgId) && !styleReady) { holdRoot("waiting for organization style"); return; }
