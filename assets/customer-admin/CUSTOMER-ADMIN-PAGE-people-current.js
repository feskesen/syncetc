...
(function () {
  ...
  function renderPersonCard(p) {
    ...
    return `<button class="people-person-card ${selectedClass}" data-open="${esc(p.membership_id)}" type="button"><span class="person-name">${esc(p.display_name || "Unnamed")}</span>${marker}</button>`;
  }
