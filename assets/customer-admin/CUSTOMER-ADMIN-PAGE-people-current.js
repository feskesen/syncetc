...
(function () {
  ...
  let options = { statuses: [], membership_classes: [], application_stages: [], roles: [], permissions: [], qualifications: [], assets: [], aircraft: [] };
  ...
  function applyPeopleListResult(res) {
    ...
    if (aircraft.length) {
      ...
      options = { ...options, assets: aircraft, aircraft };
    }
  ...
  async function loadOrgContext(loadOptions = {}) {
    ...
    if (!loadOptions.force) {
      ...
      if (cached) {
        ...
        options = cached.options || { statuses: [], membership_classes: [], application_stages: [], roles: [], permissions: [], qualifications: [], assets: [], aircraft: [] };
    ...
    options = { statuses: vocab.statuses || [], membership_classes: vocab.membership_classes || [], application_stages: vocab.application_stages || [], roles: sortRoles(vocab.roles || []), permissions: vocab.permissions || [], qualifications: vocab.qualifications || [], assets: vocab.assets || [], aircraft: vocab.aircraft || vocab.assets || [] };
